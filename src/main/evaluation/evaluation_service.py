...
class EvaluationService:
    ...
    def __init__(self, predictor: Predictor = DEFAULT_PREDICTOR,
        ...
        self.request_processor = EvaluationRequestProcessor(self.request_scaler, settings)
    ...
    def evaluate_xml(self, xml_user_request: str) -> dict:
        model_input = self.request_processor.map_to_validated_model_input(xml_user_request)
    ...
    def _evaluate_parsed_dict(self, bike_cad_dict: dict) -> dict:
        model_input = self.request_processor.map_dict_to_validated_model_input(bike_cad_dict)
        return self._model_input_to_validated_response_pipeline.process(model_input)
